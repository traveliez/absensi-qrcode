...
@section('title_prefix', 'Edit Dosen - ')

@section('content_header')
<h1>Edit Dosen</h1>

{{ Breadcrumbs::render('dosen.edit', $dosen) }}
@stop
...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
                <form role="form" method="POST" action="{{ route('dosen.update', $dosen->username) }}"
                    ...
                    <div class="box-body">
                        <div class="form-group has-feedback {{ $errors->has('photo') ? 'has-error' : '' }}">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <img src="{{ asset('vendor/images/users/'.$dosen->authable->photo) }}" alt="{{ $dosen->authable->nama }}"
                        ...
                        <div class="form-group has-feedback {{ $errors->has('nomor_induk') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="nomor_induk" name="nomor_induk"
                                placeholder="Nomor Induk Dosen" value="{{ $dosen->username }}" readonly>
                        ...
                        <div class="form-group has-feedback {{ $errors->has('nama') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama"
                                value="{{ $dosen->authable->nama }}" required>
                            @if ($errors->has('nama'))
                            <span class="help-block">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="jenis_kelamin" id="jenis_kelamin1" value="1"
                                        {{ $dosen->authable->jenis_kelamin == 'Laki-Laki' ? 'checked' : '' }}>
                                    Laki-Laki
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="jenis_kelamin" id="jenis_kelamin2" value="2"
                                        {{ $dosen->authable->jenis_kelamin == 'Perempuan' ? 'checked' : '' }}>
                                    Perempuan
                                </label>
                            </div>
